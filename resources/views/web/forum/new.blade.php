 ...
 @section('content')
     <div class="row">
         <div class="col-md-10 offset-md-1">
             ...
             <div class="card-body">
                 <div class="p-2 rounded bg-primary text-white">{{ $title }}</div>
                 <div class="mb-2"></div>
                         ...
                         <div class="card has-bg">
                             <div class="card-body">
                                 <div class="row no-gutters">
                                     ...
                                     <div class="col">
                                         <div>{{ $quote->created_at->diffForHumans() }}, <a
                                                 href="{{ route('users.profile', $quote->creator->username) }}">{{ $quote->creator->username }}</a>
                                             wrote:</div>
